module.exports = function ( grunt ) {
  ...
  var taskConfig = {
    ...
    /** Read in a local configuration file for things that change between
  ...
  grunt.registerTask( 'build', [
    ...
    'copy:build_assets', 'copy:build_appjs', 'copy:build_vendor_assets', 'copy:build_vendorjs',
      ...
      process: function ( contents, path ) {
        return grunt.template.process( contents, {
          data: {
            ...
            localConfig: grunt.config( 'localConfig' )
          }
        });
      }
    });
